...
private:
    ...
    QString bxuannamelist[100][20];
    QString bxuancodelist[100][20];
    QString kxuannamelist[100][20];
    QString kxuancodelist[100][20];
    QString lsnumersxuanlist[100][20];//数量
    QString luoxuanlist[100][20];//暂存螺栓编号
    QString proxuanlist[100][20];//程序号
    QString channelxuanlist[100][20];
    QString taotongxuanlist[100][20];

    QString bxuannamelist2[100][20];
    QString bxuancodelist2[100][20];
    QString kxuannamelist2[100][20];
    QString kxuancodelist2[100][20];
    QString lsnumersxuanlist2[100][20];//数量
    QString luoxuanlist2[100][20];//暂存螺栓编号
    QString proxuanlist2[100][20];
    QString channelxuanlist2[100][20];
    QString taotongxuanlist2[100][20];
    QString PDMxuan_Name[100][4];
    QString PDMxuan_Name2[100][4];
