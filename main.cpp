...
bool isServerTip = false;  //与服务器断开连接后，界面是否需要提示”网络异常”  add by wxm 2020/5/18
...
QString userID = "";
int taotongNum = 0 ;
bool notContrlBarcodePower = false ;
...
//#define D_WXM_DEBUG_MAIN //wxm 2020-5-13 added

int main(int argc, char *argv[])
{
    QApplication a(argc, argv, QApplication::GuiClient);
#ifndef D_WXM_DEBUG_MAIN
   ...
   **/
    ...
    configIniRead->value("baseinfo/isServerTip").toInt()?isServerTip=true:isServerTip=false;   //add by wxm 2020/5/18
    unCacheRfidFlag = configIniRead->value("baseinfo/unCacheRfidFlag").toBool();
    notContrlBarcodePower = configIniRead->value("baseinfo/notContrlBarcodePower").toBool();
    ...
    if((factory!="BYDSZ")&&(factory!="BYDXA") && (factory!="Ningbo") && (factory != "Benz") && (factory != "GM") && (factory != "Haima")&& (factory != "SVW2") && (factory != "Dongfeng") && (factory != "BAIC") && (factory != "GZBAIC"))
    {
        factory="SVW3";
    }
    ...
    Version = "VI22.09.19.1";

    qDebug()<<"factory:" <<factory << "ControlType_1:" << ControlType_1 <<"ControlType_2:"<<ControlType_2<< "Version:"<<Version<<"Station:"<<Station;
    ...
    */
    ...
    if(factory=="SVW3" || factory=="Ningbo")
    {
        ...
        */
        ...
        else if((ControlType_1 == "CS351")||(ControlType_1 == "Nexo"))
        {
            /*
              * Worker:工作线程
              * 用来接收CS351 B端口发来心跳曲线
...
//            QObject::connect(test_alive5s,SIGNAL(sendalive5s()),tighten_opnet,SLOT(timerFunc5000ms()),Qt::AutoConnection);//add 20171228
    ...
    else if(factory=="Haima")
    {
        ...
        else if(ControlType_1 == "SB356")//FTP
        {
            ...
            QObject::connect(ftpDatajson,SIGNAL(serialCom(QString,bool,QString)),w,SLOT(getSerialNum(QString,bool,QString)));   //add by wxm
            ...
            QObject::connect(ftpDatajson,SIGNAL(sendfromjsonthread(QVariant)),sqlthreadbyd,SLOT(sqlinsert(QVariant)),Qt::AutoConnection);
    ...
    else if(factory=="SVW2")
    {
        ...
        */
        ...
        if((ControlType_1 == "CS351")||(ControlType_1 == "Nexo")||(ControlType_1 == "PF_XML"))
        {
            /*
              * Worker:工作线程
              * 用来接收CS351 B端口发来心跳曲线
            */
            work = new Worker;
#ifdef D_WXM_DEBUG_MAIN
            work->xml_parse(QByteArray()); //wxm 2020-5-12 added
#endif
        ...
        else if(ControlType_1 =="PFD")//SR
        {
            ...
            else if(main_variable1 == "xml")  //左右侧配置
            {
...
//        MESUploadSVW2 *mesUploadSVW2 = new MESUploadSVW2;              //add by wxm 2020-5-9
//        QTimer::singleShot(0,mesUploadSVW2,SLOT(init()));

//        QObject::connect(mesUploadSVW2,SIGNAL(time_error(bool)),w,SLOT(time_warning(bool)),Qt::AutoConnection);//add by wxm 2020-5-9
